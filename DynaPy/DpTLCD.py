...
class TLCD(object):
    def __init__(self, tlcdType='Basic TLCD', diameter=0.6, width=20., waterHeight=1.,
                 ...
                 amount=1, contraction=1, pos=None, direction=None,
        ...
        self.contractionDampingConstant = self.calculate_contraction_damping_constant()
    ...
    def calculate_contraction_damping(self, velocity):
        return self.contractionDampingConstant * velocity